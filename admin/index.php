...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['email']) || empty($_POST['clave'])) {
            ...
            $password = mysqli_real_escape_string($conexion, $_POST['clave']); //md5(mysqli_real_escape_string($conexion, $_POST['clave']))
            $query = mysqli_query($conexion, "SELECT * FROM usuario WHERE email = '$user' AND password = '$password'");
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h2 class="h4 text-gray-900 mb-4">SUBDIRECCION DE EDUCACION ALTERNATIVA"</h2>
                                        <?php echo (isset($alert)) ? $alert : ''; ?>
                                    </div>
                                    <form class="user" method="POST" action="" autocomplete="off">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="usuario" name="email" placeholder="Usuario">
                                        </div>
                                        <div class="form-group">
